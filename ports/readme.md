...
Bir IP adresi verinin hangi cihaza gideceğini belirlerken, Port numarası o verinin cihaz içindeki hangi uygulamaya veya servise teslim edileceğini belirler. Port numaralarının hangi servislere ayrılacağını ve standartlarını IANA (Internet Assigned Numbers Authority) belirler ve bu listeyi kendi web sitesinde herkese açık ve güncel bir şekilde yayınlar. 

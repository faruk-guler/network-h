...
| Aralık | CIDR | Sınıf | Kullanım Yeri | Toplam Adres | Ağ Sayısı |
|---|---|---|---|---|---|
| 10.0.0.0 – 10.255.255.255 | /8 | A | Büyük kurumsal ağlar, veri merkezleri | 16.777.216 | 1 |
| 172.16.0.0 – 172.31.255.255 | /12 | B | Orta ölçekli kurumsal ağlar | 1.048.576 | 16 |
| 192.168.0.0 – 192.168.255.255 | /16 | C | Ev, küçük ofis ağları | 65.536 | 256 |

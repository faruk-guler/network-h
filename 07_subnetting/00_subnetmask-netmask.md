...
Yani, ağ maskesi, bir IP adresinin hangi kısmının ağla, hangi kısmının ise o ağdaki cihazlarla ilişkili olduğunu ayırır. Daha sonra bunları kullanarak, diğer cihazlarla iletişim kurmanın yolunu bulmaya çalışır. Normal şartlarda aynı ağda bulunmayan cihazlar birbirleriyle haberleşemez! bu durumda iletişim için bir router (yönlendirici) gerekir.

## Default Subnet Mask
| Sınıf | Subnet Mask | Network Kısmı | Host Kısmı | CIDR |
|:---:|:---|:---:|:---:|:---:|
| **A** | 255.0.0.0 | `255.` | `.0.0.0` | /8 |
| **B** | 255.255.0.0 | `255.255.` | `.0.0` | /16 |
| **C** | 255.255.255.0 | `255.255.255.` | `.0` | /24 |
...
```
## >_ Network ve Broadcast Hesaplama Örneği: 87.121.165.49/14

```
🔢 Adım 1: Decimal'den Binary'ye Dönüşüm
...
- Farklı departmanları izole ederek ağ güvenliğini sağlamak.

...
> 💡 Host bitlerinin tamamı **0** olduğunda **Network Adresi**, tamamı **1** olduğunda **Broadcast Adresi** oluşur. Bu iki uç adres cihazlara **atanamaz**; atanabilir aralık her subnet'te bunların arasındaki adreslerdir.

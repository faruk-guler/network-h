...
| Blok | Aralık | CIDR | Kullanım Yeri | Toplam Adres | Ağ Sayısı |
|---|---|---|---|---|---|
...
> 
> 💡 A, B, C etiketleri geleneksel sınıf karşılıklarını ifade eder; RFC 1918 aralıkları sınıftan bağımsız olarak tanımlanmıştır.
---

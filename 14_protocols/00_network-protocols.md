...
## OSI Modeli ve Önemli Katmanlar
...
| Protokol | Varsayılan Port | Protokol Türü | Kullanım Amacı |
| :--- | :--- | :--- | :--- |
| FTP | 20 (Data) / 21 (Kontrol) | TCP | Dosya Transferi |
| SSH | 22 | TCP | Güvenli Uzak Bağlantı |
| Telnet | 23 | TCP | Güvensiz Uzak Bağlantı (kullanılmamalı) |
| SMTP | 25 | TCP | E-posta Gönderimi |
| DNS | 53 | UDP / TCP | Alan Adı Çözümleme |
| DHCP | 67 / 68 | UDP | Otomatik IP Dağıtımı |
| HTTP | 80 | TCP | Web İçeriği İletimi |
| HTTPS | 443 | TCP | Güvenli Web İçeriği |
| RDP | 3389 | TCP | Uzak Masaüstü Bağlantısı |

...
## DNS Önbellek (DNS Cache) ve TTL

DNS sorguları her seferinde tüm hiyerarşiyi dolaşmaz. Çözümlenen kayıtlar, bant genişliğinden tasarruf etmek ve yanıt süresini milisaniyelere indirmek için yerel bellekte saklanır. Bir kaydın önbellekte ne kadar süre saklanacağını ise alan adının sahibi tarafından belirlenen **TTL (Time to Live)** süresi belirler.

...
## 3. Frame İletimi ve Hata Kontrolü (Store-and-Forward)

Modern switch'ler standart olarak **Store-and-Forward** yöntemini kullanır:

1. Gelen frame'in **tamamı** belleğe alınır.
2. Frame sonundaki hata kontrol kodu (**FCS — Frame Check Sequence**) incelenerek paketin bozulup bozulmadığı kontrol edilir.
3. Hatalı veya hasarlı frame'ler doğrudan çöpe atılır; yalnızca sağlam veriler hedef porta iletilir.

> 💡 Bu sayede ağda bozuk paketlerin dolaşması engellenir, güvenilirlik ve veri bütünlüğü garanti altına alınır.

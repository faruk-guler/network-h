...
>
> 💡 Ağda 2 adres kullanılmaz, birisi network address (ağın kendisi), diğeri broadcast address (tüm cihaza gönderim) olduğu için toplamdan çıkarılır.
...
CIDR'nin gelişmiş bir alt kümesidir. Değişken Uzunluklu Alt Ağ Maskesi anlamına gelir. Aynı ağ bloğu içinde farklı boyutlarda subnetler oluşturmanıza olanak tanıyan tekniktir. IP israfı CIDR'e göre daha da azalmıştır.
```

...
Subnet Mask'ın daha net ve anlaşılır bir biçimde gösterimidir. IP adreslerini sınıfsız (class A/B/C'ye bakmadan) bölme yöntemidir. 1993 yılında tanıtılmıştır. IP adreslerini ve ağları verimli bir şekilde "bölmek" için kullanılır. Aslında ISP’lerin (internet servis sağlayıcıların), bir firma ya da ev kullanıcısı için bir adres ayırmak için kullandıkları yöntemde budur.

...
- Bir cihaz IP adresi ile subnet maskını mantıksal olarak "AND" işlemine tabi tutar, çıkan değer cihazın network adresi olur. Cihaz hangi ağda olduğunu öğrendikten sonra  bulunduğu ağ içindeki diğer cihazlara doğrudan erişebilir.
